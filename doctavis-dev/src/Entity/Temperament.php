...
use App\Repository\TemperamentRepository;
...
/**
 * @ORM\Entity(repositoryClass=TemperamentRepository::class)
 */
class Temperament
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Practitioner::class, mappedBy="temperaments")
     */
    ...
    public function addPractitioner(Practitioner $practitioner): self
    {
        if (!$this->practitioners->contains($practitioner)) {
            ...
            $practitioner->addTemperament($this);
        }
    ...
    public function removePractitioner(Practitioner $practitioner): self
    {
        if ($this->practitioners->removeElement($practitioner)) {
            $practitioner->removeTemperament($this);
        }
